...
import { NativeBaseProvider, Input, Icon, Image, Radio, Button, Badge, Stack, TextArea, Text, Pressable, Box, VStack, Center, Divider, ScrollView, HStack } from 'native-base'
                                            ...
                                            <Box w="96" h="40" bg="info.500" rounded="2xl" shadow={3}>
                                                ...
                                                <HStack left="6" mt="3" >
                                                    ...
                                                    <Badge size="sm" mt="1" bg="#facc15">
                                                        <Text fontWeight="bold" color="light.50">Rp {transaction.totalPrice.toLocaleString()}</Text>
                                                    </Badge>
                                                </HStack>
                                            </Box>
                                        </Pressable>
