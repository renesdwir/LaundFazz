...
export default function MyHistoryPage() {
  ...
  const { loading2, error, data: data2, refetch } = useQuery(GET_TRANSACTIONS);
  useEffect(() => {
    refetch();
  }, []);
  // console.log(data2?.getUserTransactions);
          ...
          {loading ? (
            ...
            <>
              <h1 className="text-xl font-semibold capitalize ">
                <span className="text-xl font-extrabold text-sky-500">Hi</span>,{" "}
